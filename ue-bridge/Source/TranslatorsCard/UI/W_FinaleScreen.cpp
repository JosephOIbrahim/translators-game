    ...
    : Super(ObjectInitializer)
{
    ...
    SubtitleColor = FTranslatorsStyle::GetColor("Color.TextSecondary");
    TraitLabelColor = FTranslatorsStyle::GetColor("Color.CyanFaint");
    TraitValueColor = FTranslatorsStyle::GetColor("Color.TextPrimary");
    InsightColor = FTranslatorsStyle::GetColor("Color.Insight");
    DimColor = FTranslatorsStyle::GetColor("Color.TextMuted");
}
...
void UW_FinaleScreen::DisplayProfile(const FTranslatorsProfile& Profile)
{
    ...
    if (TraitsContainer)
    {
        ...
        for (const FTranslatorsTrait& Trait : Profile.Traits)
        {
            ...
            DimText->SetFont(FTranslatorsStyle::GetFont("Font.Caption"));
            ...
            LabelText->SetFont(FTranslatorsStyle::GetFont("Font.Progress"));
            ...
            ScoreText->SetFont(FTranslatorsStyle::GetFont("Font.Caption"));
            ...
            if (!Trait.Behavior.IsEmpty())
            {
                ...
                BehaviorText->SetFont(FTranslatorsStyle::GetFont("Font.Small"));
    ...
    if (InsightsContainer)
    {
        ...
        for (const FString& Insight : Profile.Insights)
        {
            ...
            InsightText->SetFont(FTranslatorsStyle::GetFont("Font.Insight"));
...
void UW_FinaleScreen::BuildWidgetTree()
{
    ...
    TitleText->SetFont(FTranslatorsStyle::GetFont("Font.Heading"));
    ...
    SubtitleText->SetFont(FTranslatorsStyle::GetFont("Font.Body"));
    ...
    TraitsHeader->SetFont(FTranslatorsStyle::GetFont("Font.Caption"));
    ...
    InsightsHeader->SetFont(FTranslatorsStyle::GetFont("Font.Caption"));
    ...
    ChecksumText->SetFont(FTranslatorsStyle::GetFont("Font.Small"));
    ...
    PathText->SetFont(FTranslatorsStyle::GetFont("Font.Small"));
